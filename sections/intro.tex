...
\REVIEW{There is also a significan amount of labor involved in the conversion between analysis and design geometries (CUBIT at Sandia is a long-term effort to provide semi-automated tools).}
    ...
    To accompany the theory behind HBS, a C++ library (HBS \REVIEW{I would use \texttt{hbs} instead of caps} will henceforth refer to the C++ library) is being developed that implements these concepts. C++ was an appropriate language choice for the implementation of HBS for a number of reasons:
