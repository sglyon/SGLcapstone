%%% Preamble
  ...
  \newcommand{\REVIEW}[1]{ {\color{red} REVIEW: #1} }

  \newcommand{\COMMENT}[1]{ {\pdfcomment{#1}} }

  \newenvironment{code}{\setstretch{0.7} \begin{lstlisting}}{\end{lstlisting} \mainstretch{}}
...
%% Abstract page
  ...
  % Fill then keywords
  \vfill
  \noindent Keywords: Python, C++, Isogeometric geometry, B-splines, NURBS
...
\input{../sections/app_cython}
\input{../sections/app_initplug}
\input{../sections/app_install}
